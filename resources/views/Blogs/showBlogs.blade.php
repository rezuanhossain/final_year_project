	...
	@foreach($blogs as $blog)
        <div class="row">
            ...
            <div class="col-lg-8">
				...
				<div style="max-height: 22rem;overflow:hidden!important;">
					<p class="mb-4">{!!$blog->content!!}</p>
				</div>
				

				<a href="{{route('show.blog',$blog->id)}}" target="_blank" class="btn btn-info btn-icon btn-round-full my-3">Read More <i class="icofont-simple-right ml-2  "></i></a>
			</div>
